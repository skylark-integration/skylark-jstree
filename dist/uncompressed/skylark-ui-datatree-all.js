...
define('skylark-ui-datatree/tree',[
  ...
  "skylark-utils/widgets"
    ...
    var Tree = ui.Tree = widgets.Widget.inherit({
        klassName: "Tree",
...
define('skylark-ui-datatree/plugin/menu',[
  "skylark-utils/langx",
  "skylark-utils/browser",
  "skylark-utils/eventer",
  "skylark-utils/noder",
  ...
  "skylark-utils/query",
  "skylark-utils/widgets"
],function(langx,browser,eventer,noder,geom,velm,$,widgets){

	var popup = null;
	var right_to_left ;

	var Menu = widgets.Widget.inherit({
        klassName: "Menu",
