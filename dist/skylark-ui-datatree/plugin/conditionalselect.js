 ...
 * @license MIT
 */
define(["skylark-utils/langx","skylark-utils/browser","skylark-utils/eventer","skylark-utils/noder","skylark-utils/geom","skylark-utils/velm","skylark-utils/query","../tree"],function(t,e,s,i,l,n,r,a){"use strict";if(!r.jstree.plugins.conditionalselect)return r.jstree.defaults.conditionalselect=function(){return!0},r.jstree.plugins.conditionalselect=function(t,e){this.activate_node=function(t,s){if(this.settings.conditionalselect.call(this,this.get_node(t),s))return e.activate_node.call(this,t,s)}},r});
